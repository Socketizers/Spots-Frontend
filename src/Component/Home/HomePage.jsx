          ...
          <Container>
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav>
                ...
                <Nav.Link style={{ color: "white" }} to="/about-us">
                  About Us
                </Nav.Link>
                <Nav.Link style={{ color: "white" }} href="/sign-in">
                 <button>Sign Up</button> 
                </Nav.Link>
                <Nav.Link style={{ color: "white" }} href="/sign-up">
                  Login
                </Nav.Link>
              </Nav>
            </Navbar.Collapse>
...
<div style={{position:'relative'}}>
      ...
      <img
        style={{ width: "100%", marginBottom: "20px", height: "55em",position: 'absolute',
        top:'125em',zIndex: '-2' }}
        src={f7}
      />
      </div>
